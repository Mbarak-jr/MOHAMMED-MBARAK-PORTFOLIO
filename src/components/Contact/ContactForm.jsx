const ContactForm = () => {
    return (
      <div className="bg-gradient-to-br from-white to-blue-50 p-8 rounded-xl shadow-lg max-w-2xl mx-auto border border-blue-100">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-800 mb-2">Let's Connect</h2>
          <p className="text-blue-600">I'd love to hear from you! Send me a message or reach out directly.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="md:col-span-1">
            <form className="space-y-5">
              ...
              <button 
                type="submit" 
                className="w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white px-6 py-3 rounded-lg font-medium hover:from-blue-700 hover:to-blue-600 transition-all shadow-md hover:shadow-lg"
              >
                Send Message
              </button>
            </form>
          ...
          {/* Contact Information */}
          <div className="md:col-span-1 bg-white p-6 rounded-xl shadow-inner border border-blue-100">
            <h3 className="text-xl font-semibold text-gray-800 mb-6 pb-2 border-b border-blue-100">Direct Contact</h3>
            ...
            <div className="space-y-5">
              <div className="flex items-start">
                ...
                <div className="ml-4 min-w-0">
                  ...
                  <a 
                    ...
                    title="mohammedmbarak77@gmail.com"
                  >
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <a href="tel:+254707893724" className="text-gray-700 hover:text-blue-600">+254 707 893 724</a>
                </div>
              </div>
