            ...
            <div className="flex justify-center">
              <div className="space-y-4">
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="/resume" className="text-gray-400 hover:text-blue-400 transition-colors">Resume</a></li>
              ...
              <div className="space-y-4">
                ...
                <div className="flex space-x-4">
                  ...
                  <a 
                    ...
                    className="bg-gray-700 hover:bg-red-500 text-white p-3 rounded-full transition-colors duration-300"
                    aria-label="Email"
                  >
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="border-t border-gray-700 pt-6">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400 text-sm mb-4 md:mb-0">
                © {new Date().getFullYear()} Mohammed Mbarak. All rights reserved.
              </p>
